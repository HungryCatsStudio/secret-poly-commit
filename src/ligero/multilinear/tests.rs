...
mod tests {
    ...
    use ark_poly::{
        domain::general::GeneralEvaluationDomain,
        evaluations::multivariate::{MultilinearExtension, SparseMultilinearExtension},
    ...
    fn test_encoding() {
        ...
        for i in 1..10 {
            ...
            let mut pol = rand_poly::<Fr>(deg, Some(5), rand_chacha);

            while pol.degree() != deg {
                pol = rand_poly::<Fr>(deg, Some(5), rand_chacha);
            }

            let coeffs = &pol.to_evaluations();
            ...
            //     assert_eq!(
            //         Polynomial::evaluate(&pol, &large_domain.element(j)),
            //         encoded[j]
            //     );
            // }
        }
    ...
    fn test_construction() {
        ...
        let labeled_poly = LabeledPolynomial::new(
            "test".to_string(),
            rand_poly(degree, Some(5), rand_chacha),
            Some(5),
            Some(5),
        );
